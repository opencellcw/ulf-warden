...
class LearningDatabase {
    ...
    storeInsightsBatch(insights) {
      ...
      `);
            const insertMany = this.db.transaction((insights) => {
                const ids = [];
            ...
            logger_1.log.info('[LearningDB] Insights batch stored', {
            ...
            logger_1.log.error('[LearningDB] Failed to batch store insights', {
                error: error.message,
                count: insights.length
            });
            throw error;
