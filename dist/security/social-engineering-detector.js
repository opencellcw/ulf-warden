...
exports.socialEngineeringDetector = exports.SocialEngineeringDetector = void 0;
class SocialEngineeringDetector {
     ...
     */
    analyze(userId, platform, message, command) {
        const attackTypes = [];
        let riskScore = 0;
...
exports.SocialEngineeringDetector = SocialEngineeringDetector;
// Global instance
exports.socialEngineeringDetector = new SocialEngineeringDetector();
