...
exports.SLACK_MESSAGING_TOOL = void 0;
exports.initSlackMessaging = initSlackMessaging;
 ...
 */
function initSlackMessaging(app) {
    slackApp = app;
    logger_1.log.info('[SlackMessaging] Initialized');
}
/**
...
async function sendSlackMessage(input) {
    ...
    try {
        ...
        logger_1.log.info('[SlackMessaging] Sending message', {
            channel,
        ...
        if (result.ok) {
            logger_1.log.info('[SlackMessaging] Message sent successfully', {
                channel,
                ts: result.ts
            });
            ...
            logger_1.log.error('[SlackMessaging] Failed to send message', {
                error: result.error,
                channel
            });
        ...
        logger_1.log.error('[SlackMessaging] Error sending message', {
            error: error.message,
            channel
        });
